...
const CACHE_NAME = 'flatspace-commander-v1.2';

// ─── Assets to pre-cache on install ───────────────────────────────────────────
const ASSETS = [
    '/',
    '/index.html?v=1775590841918',
    '/manifest.json',
    '/css/style.css?v=1775590841918',
    '/js/main.js?v=1775590841918',
    '/js/combat.js?v=1775590841918',
    '/js/procedural.js?v=1775590841918',
    '/js/vendor/howler.js?v=1775590841918',
    '/img/background.png',
