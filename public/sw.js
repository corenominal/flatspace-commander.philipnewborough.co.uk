...
const CACHE_NAME = 'flatspace-commander-v1.1';

// ─── Assets to pre-cache on install ───────────────────────────────────────────
const ASSETS = [
    '/',
    '/index.html?v=1775590562032',
    '/manifest.json',
    '/css/style.css?v=1775590562032',
    '/js/main.js?v=1775590562032',
    '/js/combat.js?v=1775590562032',
    '/js/procedural.js?v=1775590562032',
    '/js/vendor/howler.js?v=1775590562032',
    '/img/background.png',
