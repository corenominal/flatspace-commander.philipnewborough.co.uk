...
import { GalaxyGenerator, getMarketPrices, COMMODITIES } from './procedural.js?v=1';
import { SHIP_CATALOG, generateCombatScenario, CombatEncounter } from './combat.js?v=1';
